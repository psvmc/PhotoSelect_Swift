...
- (void)setupNavigationbar{
    if(self.navigationBarColor == nil){
        self.navigationBarColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:0.1];
    }

    [self.navigationBar setTranslucent:YES];
    [self.navigationBar setBarStyle:UIBarStyleBlackTranslucent];
    [self.navigationBar setBackgroundImage:nil forBarMetrics:UIBarMetricsDefault];
    [self.navigationBar setBackgroundColor:self.navigationBarColor];
    [self.navigationBar setBarTintColor:self.navigationBarColor];
    [self.navigationBar setTintColor:self.navigationBarColor];
}
