...
- (void)setControlsHidden:(BOOL)hidden animated:(BOOL)animated{
    ...
    [UIView animateWithDuration:animationDuration animations:^(void) {
        ...
        if (hidden){
            _toolbar.frame = CGRectOffset(frame, 0, animatonOffset);
...
- (BOOL)areControlsHidden { return (self.navigationController.navigationBar.hidden); }
